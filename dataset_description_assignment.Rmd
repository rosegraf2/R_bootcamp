...
Conclusion: there is a slight correlation between bmi and systolic blood pressure. 
```{r}
...
```
Conclusion: there is a slight significant correlation between diastolic and bmi
```{r}
...
p7 <- ggplot(mydata, aes(x=bmi, y=diastolic)) +
  geom_point(color="#3c7d3e") +
  geom_smooth(method=lm , color="red", fill="#69b3a2", se=TRUE) +
  theme_ipsum() +
